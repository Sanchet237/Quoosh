...
export default function AITab({ onAdd }: AITabProps) {
  ...
  return (
    <div className="absolute inset-0 flex flex-col border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm m-6 mt-0">
      ...
      <div className="p-4 bg-white border-t border-gray-200 shrink-0">
        <form onSubmit={handleSubmit} className="flex gap-2">
          <input
            className="flex-1 bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 text-black placeholder-gray-400 font-medium focus:outline-none focus:border-blue-500 focus:bg-white transition-all text-sm"
            value={input}
            placeholder='E.g. "10 questions on Space Science, medium difficulty"'
          ...
          <button
            ...
            className="flex items-center justify-center bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white px-5 font-bold rounded-lg transition-colors text-sm"
          >
            Send ↵
          </button>
        </form>
